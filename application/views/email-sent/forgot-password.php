													...
													<table border="0" cellpadding="0" cellspacing="0" class="image_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-top:20px;width:100%;padding-right:0px;padding-left:0px;">
																<div align="left" class="alignment" style="line-height:10px"><img alt="Image" src="images/ecommerce-template_logo.png" style="display: block; height: auto; border: 0; width: 186px; max-width: 100%;" title="Image" width="186" /></div>
															</td>
														</tr>
													</table>
												</td>
