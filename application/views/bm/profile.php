                ...
                <div class="col-md-8">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('bm/channel/updateprofile'); ?>" class="btn btn-primary">Update Profile</a>
                            <?php if ($bank == null) : ?>
                            <?php else : ?>
                                <a href="<?= base_url('bm/channel/bank_account'); ?>" class="btn btn-warning">Update Bank</a>
                            <?php endif; ?>
