			...
			<div class="row">
				<div class="col">
					<div class="card">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form action="<?= base_url('cs/dashboard/setting'); ?>" method="post">
								<div class="form-group">
									<label for="exampleInputPassword1">Password Saat Ini</label>
									<input autocomplete="off" type="password" class="form-control" id="old_pass" name="old_pass">
									<?= form_error('old_pass', '<small class="text-danger">', '</small>'); ?>
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Password Baru</label>
									<input autocomplete="off" type="password" class="form-control" id="n_pass1" name="n_pass1">
									<?= form_error('n_pass1', '<small class="text-danger">', '</small>'); ?>
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Ulangi Password Baru</label>
									<input autocomplete="off" type="password" class="form-control" id="n_pass2" name="n_pass2">
					...
					<div class="card">
						...
						<div class="card-body">
							<p>Ingat jika anda menghapus akun anda, maka seluruh data anda akan terhapus
								<br>
								Seirng anda mengajukan permintaan penghapusan, anda tidak akan bisa login kembali
								<br>
